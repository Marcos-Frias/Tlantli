 ...
 class conexionBD {
  ...
  var $cadena = "mysql:host=127.0.0.1;dbname=tlantli";
  var $user = "root";
  var $password = "root";
  var $conn;
  var $depuracion = true;
  ...
  public function open() {
     try {
   	...
   	public function ConsultaPreparada($sql, $parametros) {
         if ($this->conn == NULL)
             $this->open();
     ...
     public function ConsultaAsociativaOrdenada($tabla, $filtro, $orden, $parametros) {
         if ($this->conn == NULL)
             $this->open();
