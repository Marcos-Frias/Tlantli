    ...
    <div class="col s12 z-depth-4 card-panel">
      <form class="login-form" method="post">
        ...
        <div class="row">
          ...
          <p class="margin medium-small center"><a href="user-forgot-password.html">¿Olvidaste la contraseña?</a></p>
          </div>
					<!--
          <div class="input-field col s4 m4 l6">
              <p class="margin right-align medium-small"><a href="user-forgot-password.html">¿Olvidaste la contraseña?</a></p>
          </div> -->
        </div>
